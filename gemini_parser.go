...
- replace the word: "peco peco" to "PecoPeco", "cavalo marinho" to "Cavalo-Marinho", "louva a deus" to "Louva-a-Deus", "Besouro Ladrão" to "Besouro-Ladrão", "Bigode de Toupeira" to "Bigodes de Toupeira"
