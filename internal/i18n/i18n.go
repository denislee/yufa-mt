...
var (
	translationsMap = map[string]map[string]string{
		"en": {
			...
			"was_sold":               "was sold.",
			"partially_sold":         "was partially sold.",
			"left":                   "left",
			...
			"not_ranked_notice": "This character isn't in the rankings, so level, rank and zeny aren't available. The history below is reconstructed from the chat log.",
			...
			"nav_font_size":       "Global Font Size",
			"nav_table_font_size": "Table Font Size",
		...
		"pt": {
			...
			"partially_sold":         "foi parcialmente vendido.",
			"left":                   "restantes",
			...
			"not_ranked_notice": "Este personagem não está no ranking, então nível, rank e zeny não estão disponíveis. O histórico abaixo é reconstruído a partir do chat.",
			...
			"nav_language":      "Idioma",
			"nav_font_size":       "Tamanho da Fonte (Global)",
			"nav_table_font_size": "Tamanho da Fonte (Tabelas)",
