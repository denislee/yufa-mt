...
// ItemDBEntry and ItemDBFile moved to internal/itemdb.
...
// GeminiTradeItem and GeminiTradeResult moved to internal/gemini; type
// aliases in gemini_parser.go preserve the legacy names for callers.
